...
|---|---|---|
| AO1 | Can customer characteristics and previous purchasing behavior predict whether a customer will become a future high spender? | Gigi |
| AO2 | Can spending behavior and age predict customer membership status? | Rosarie |
| AO3 | Does the sales channel (online vs. store) relate to spending patterns? | Michelle |
| AO4 | Can historical customer behavior predict a customer's future RFM value? | Frank |
| AO5 | Can customer age group and purchase history predict the time between purchases? | Daisy |
...
## Conclusion {.importance-slide .dense-slide background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16"}

::: {.content-panel}

### Key Findings

- **Customer behavior was generally more informative than demographics**
- Prior spending was the strongest signal for predicting future high spenders
- Purchase frequency was more useful than total spending for identifying membership disengagement
- **Product group mattered more than sales channel** when explaining spending
- RFM models identified **Inactive and High Value** customers better than middle-value groups
- Purchase count was far more useful than age for predicting purchase timing

### Recommendations for H&M

- Prioritize **purchase history, frequency, and customer value** when targeting campaigns
- Use different strategies for **High Value, Mid/Low Value, and Inactive** customers
- Use model predictions as **decision-support tools**, not exact customer classifications

### Limitations & Future Research

- Several models showed only **moderate or weak predictive performance**
- Important factors such as promotions, preferences, loyalty behavior, and campaign response were not fully captured
- Future models should incorporate richer behavioral features and additional customer interactions
...
**Presentation Slides**  
[Github Pages](https://michelleeediazzz.github.io/IBM-6540-Group-Project-/Group4-Slides.html#/section)
