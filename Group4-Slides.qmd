...
**Plan for data visualization:**  
Use a segment bar chart to compare customer counts, an RFM summary table to explain each segment’s average recency, frequency, and monetary value, and a scatter plot of frequency vs. monetary value colored by cluster. These visuals can support marketing actions such as retention, re-engagement, promotion targeting, and campaign timing.
