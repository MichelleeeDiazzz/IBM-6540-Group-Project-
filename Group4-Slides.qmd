...
## AO1: Predicting Future High-Spending Customers {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}
...
## AO1: Data Wrangling & Model Setup {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}

::: {.content-panel .panel-small}

**Data Wrangling**

- Combined H&M customer information with transaction history
- Used transactions before July 1, 2020 to create predictors
- Used later transactions to measure future spending
- Created customer-level purchasing features
- Defined High Spenders as customers above the median future spending level
- Separated feature and outcome periods to avoid data leakage
...
- Average purchase price and unique products
...
- 10-fold cross-validation for final model comparison

:::

## AO1: Prediction & Model Evaluation {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}
...
## AO1: XGBoost Interpretation {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}

::: {.content-panel .panel-small}

### Variable Importance

- **Prior total spending** was by far the strongest feature
- Online purchase share and age also contributed
- Previous purchasing behavior provided more predictive information than demographic characteristics alone

### Partial Dependence

The predicted probability of becoming a High Spender generally **increased as prior total spending increased**.

### SHAP Analysis

- Unknown Fashion News subscription status and prior total spending had the largest average effects on individual predictions
- Unknown subscription status should be interpreted carefully because it represents missing or unclear customer information

**Overall:** A customer's previous purchasing behavior was the strongest indicator of future high-spender status.

:::


## AO1: Summary Findings {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}

::: {.content-panel .panel-small}

### Key Findings

- XGBoost achieved the highest CV ROC AUC at **0.622**
- Lasso Logistic Regression performed almost as well at **0.620**
- Prior total spending was the strongest feature in the XGBoost model
- Higher previous spending generally increased the predicted probability of becoming a future High Spender
- Fashion News subscription status was less informative than purchasing behavior overall

### Business Takeaway

H&M should focus primarily on **previous purchasing behavior** when identifying customers who may become future high spenders.

Customers showing stronger previous spending activity could receive more personalized promotions and product recommendations.

The model should be used as a **decision-support tool**, since overall predictive performance was moderate.
...
## Appendix {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}
