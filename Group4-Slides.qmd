...
## AO1: Data Wrangling & Model Setup
...
Higher prior spending generally increased the predicted probability of becoming a High Spender.

**SHAP**

- Unknown Fashion News status and prior spending had the largest average effects
- Unknown status should be interpreted carefully because it represents missing information

**Overall:** Previous purchasing behavior was the strongest indicator of future high-spender status.
...
Focus on previous purchasing behavior when identifying potential high spenders.

Customers with stronger prior spending may benefit from personalized promotions and recommendations.

Use the model as a **decision-support tool**, since predictive performance was moderate.
