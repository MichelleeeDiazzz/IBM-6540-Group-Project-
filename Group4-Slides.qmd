...
- **XGBoost** had the highest CV ROC AUC (**0.622**), closely followed by Lasso (**0.620**)
- **Prior total spending** was the strongest XGBoost feature
- Higher prior spending generally increased predicted High-Spender probability
- Purchasing behavior was more informative than Fashion News status overall

### Business Takeaway

- Focus on **previous purchasing behavior** to identify potential high spenders
- Prioritize stronger spenders for personalized promotions and recommendations
- Use the model as a **decision-support tool** because predictive performance was moderate
