...
**Plan for data wrangling:**  
Aggregate transaction data by customer ID, calculate each customer’s most recent purchase, purchase count, and total spending. Then apply course techniques such as feature engineering, missing value handling, log transformation, and scaling so the RFM variables are ready for clustering.
