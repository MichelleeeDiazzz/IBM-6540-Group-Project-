...
**Plan for data wrangling:**  
Aggregate transaction data by customer ID to calculate each customer’s most recent purchase, purchase count, and total spending. Then apply course techniques such as feature engineering, log transformation, scaling, and time-based train/validation split before running K-means clustering.

**Plan for data visualization:**  
Use a segment bar chart to show the percentage of customers in each group, an RFM summary table to compare average recency, frequency, and monetary value, and a scatter plot of frequency vs. monetary value colored by segment. These segments can support VIP retention, personalized recommendations, promotion targeting, and re-engagement campaigns.
:::
