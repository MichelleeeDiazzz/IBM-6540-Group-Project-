...
| RO2 | Can spending behavior and age help explain which customers are more likely to leave the membership program? | Rosarie |
...
## RO2: Predicting Membership Status from Spending and Age {background-image="assets/importance-topic.png" background-size="cover" background-opacity="0.16" .importance-slide}
...
**Plan for data visualization:** A stacked bar chart showing the distribution of Membership Status across different Age Brackets, and a box plot comparing total spending across membership groups to see whether spending patterns help explain which customers are more likely to have left.
